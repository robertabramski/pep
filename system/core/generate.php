			...
			"<?php\n\n" .
				...
				"\t{\n" .
					...
					"\t\t{\n" .
						...
						"\t\t\t(\n" .
						"\t\t\t\t  /**\n" .
						"\t\t\t\t   * Add your fields to display in the admin interface here. See the \n" .
						"\t\t\t\t   * examples below.\n" . 
						"\t\t\t\t   * \n" . 
						...
						"\t\t\t\t   * The following are the supported types. If no name key is given, it will default to no input displayed.\n" . 
						"\t\t\t\t   * \n" . 
